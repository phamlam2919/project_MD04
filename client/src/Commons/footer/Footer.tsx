...
const Footer = () => {
    return (
        <div className="bg-black text-white">
            <div style={{ padding: "50px 80px" }} className=" flex gap-8">
                <div className="w-72">
                    <img
                    ...
                    >
                        Marshall Store Vietnam mong muốn đem đến những sản phẩm
                        đẹp, chất lượng cùng những câu chuyện và những trải
                        nghiệm mới mẻ cho khách hàng của mình với dịch vụ tốt
                        nhất.
                    </p>
                </div>
                <div className="flex justify-between w-full">
                    ...
                    <div>
                        <h3
                            ...
                            className="text-xl"
                        >
                            MARSHALL STORE VIETNAM
                        </h3>
                        <p>
                            Đại lý/ Dự án: 092.6562.888 <br /> Mail:
                            marshallstorevietnam.vn@gmail.com
                        </p>
                    </div>
                </div>
            </div>
            ...
            >
                <div>
                    <small>
                        <a href="">
                            <strong>Marshall Store Vietnam</strong>
                        </a>
                        <i className="fa fa-copyright"></i> 2023.
                    </small>
                </div>
                <div>
                    <img
